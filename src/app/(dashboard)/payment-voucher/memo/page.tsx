      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            {errors.sendTo && (
              <p className="mt-1 text-sm text-red-600">{errors.sendTo.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="cc1" className="block text-sm font-medium text-gray-700 mb-1">
              CC1
            </label>
            <select
              id="cc1"
          ...
          <div>
            <label htmlFor="cc1Action" className="block text-sm font-medium text-gray-700 mb-1">
              CC 1 action
            </label>
            <select
              id="cc1Action"
